...
Begin VB.Form frmAllPTSDueCheck 
   BackColor       =   &H00F5F5F5&
   BorderStyle     =   0  'None
   Caption         =   "Due Checks (Supplier)"
   ClientHeight    =   5685
   ClientLeft      =   0
   ClientTop       =   105
   ClientWidth     =   8010
   ...
   EndProperty
   Icon            =   "frmAllPTSDueCheck.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
      ...
      Begin MSComctlLib.ImageList ilList 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmAllPTSDueCheck.frx":000C
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin b8Controls4.b8TitleBar b8TB 
      ...
      _ExtentX        =   10927
      _ExtentY        =   661
      Caption         =   "Manage Due Checks (Payments to Supplier)"
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Arial"
         Size            =   12
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmAllPTSDueCheck"
...
Private Function FillDueCheck() As Boolean
    ...
    sSQL = "SELECT tblPTS.PTSDate, tblPTS.PTSID, tblPTS.FK_SupID, tblSup.SupName, tblPTS.CheckNo, tblPTS.AccountName, tblPTS.DateIssued, tblPTS.DateDue, tblPTS.AccountNo, tblPTS.BankName, tblPTS.Amount, tblPTS.Remarks, tblPTS.RC, tblPTS.RM, tblPTS.RCU, tblPTS.RMU" & _
            " FROM tblSup INNER JOIN tblPTS ON tblSup.SupID = tblPTS.FK_SupID" & _
            " Where LCase$([tblPTS].[FP]) = 'check' And tblPTS.Cleared = False AND DateValue(tblPTS.DateDue)>=DateValue(#" & dCurMinDate & "#) AND DateValue(tblPTS.DateDue)<=DateValue(#" & dCurMaxDate & "#)" & _
    ...
    While vRS.EOF = False
        ...
        With listEntries
            li = .AddItem(Format$(ReadField(vRS.Fields("PTSDate")), modGV.GV_DateFormat))
            .ItemImage(li) = 1
            
            .CellText(li, 1) = modFunction.ComNumZ(ReadField(vRS.Fields("PTSID")), 10)
            .CellText(li, 2) = modFunction.ComNumZ(ReadField(vRS.Fields("FK_SupID")), 10)
            .CellText(li, 3) = ReadField(vRS.Fields("SupName"))
...
Public Function Form_Add()
    ...
    If frmPTSEntry.ShowAdd(mdiMain.b8DateP.MaxDate) = True Then
        Form_Refresh
    End If
...
Public Function Form_Delete()
    ...
    If GetPTSByID(CLng(vID), tmpPTS) = False Then
        Exit Function
    End If
