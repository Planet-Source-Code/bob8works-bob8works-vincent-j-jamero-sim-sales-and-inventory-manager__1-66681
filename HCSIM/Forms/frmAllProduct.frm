...
Begin VB.Form frmAllProduct 
      ...
      Begin MSComctlLib.ImageList ilList 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmAllProduct.frx":000C
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin b8Controls4.b8TitleBar b8TB 
      ...
      _ExtentX        =   10927
      _ExtentY        =   661
      Caption         =   "Manage Product Entries"
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Arial"
         Size            =   12
         Charset         =   0
...
Private Sub Form_Load()
    ...
    With listEntries
        ...
        .AddColumn "Product ID", 120        '0
        .AddColumn "Code", 90               '1
        .AddColumn "Description", 200       '2
        .AddColumn "Package", 90            '3
        .AddColumn "Category", 80           '4
        .AddColumn "Sup. Price", 80, lgAlignRightCenter '5
        .AddColumn "SRPrice", 80, lgAlignRightCenter '6
        
        .AddColumn "Active", 60, lgAlignCenterCenter '7
        .AddColumn "Created", 0             '8
        .AddColumn "By", 0                  '9
        .AddColumn "Modified", 0            '10
        .AddColumn "By", 0                  '11
...
Private Sub LoadEntries()
    ...
    'set SQL Expression
    sSQL = "SELECT tblProd.ProdID, tblProd.ProdCode, tblProd.ProdDescription, tblPack.PackTitle, tblCat.CatTitle, tblProd.SupPrice, tblProd.SRPrice, tblProd.Active, tblProd.RC, tblProd.RM, tblProd.RCU, tblProd.RMU" & _
    ...
    While vRS.EOF = False
        ...
        With listEntries
            il = .AddItem(modFunction.ComNumZ(ReadField(vRS.Fields("ProdID")), 10))
            .ItemImage(il) = 1
            .CellText(il, 1) = ReadField(vRS.Fields("ProdCode"))
            .CellText(il, 2) = ReadField(vRS.Fields("ProdDescription"))
            .CellText(il, 3) = ReadField(vRS.Fields("PackTitle"))
            .CellText(il, 4) = ReadField(vRS.Fields("CatTitle"))
            
            .CellText(il, 5) = ReadField(vRS.Fields("SupPrice"))
            .CellText(il, 6) = ReadField(vRS.Fields("SRPrice"))
            
            .CellText(il, 7) = IIf(ReadField(vRS.Fields("Active")), "YES", "NO")
            .CellText(il, 8) = ReadField(vRS.Fields("RC"))
            .CellText(il, 9) = ReadField(vRS.Fields("RCU"))
            .CellText(il, 10) = ReadField(vRS.Fields("RM"))
            .CellText(il, 11) = ReadField(vRS.Fields("RMU"))
...
Public Function Form_Edit()
    ...
    lProdID = GetTxtVal(listEntries.CellText(listEntries.Row, 0))
...
Public Function Form_Delete()
    ...
    If MsgBox("Are you sure you want to delete this Product entry named   '" & listEntries.CellText(listEntries.Row, 2) & "' ?", vbQuestion + vbYesNo + vbDefaultButton2) <> vbYes Then
        Exit Function
    End If
    ...
    If DeleteProd(lProdID) = True Then
        Form_Refresh
    Else
        WriteErrorLog Me.Name, "Form_Delete", "Failed on: 'DeleteProd(lProdID) = True'"
    End If
