...
Begin VB.Form frmAllSupplier 
      ...
      Begin MSComctlLib.ImageList ilList 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmAllSupplier.frx":000C
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   End
End
Attribute VB_Name = "frmAllSupplier"
...
Private Sub LoadEntries()
    ...
    'set SQL Expression
    sSQL = "SELECT tblSup.SupID, tblSup.SupName, tblSup.CPName, tblSup.CPPosition, tblSup.Address, tblSup.ContactNumber, tblSup.BegAP, tblSup.Active, tblSup.RC, tblSup.RM, tblSup.RCU, tblSup.RMU" & _
            " From tblSup" & _
    ...
    While vRS.EOF = False
        ...
        With listEntries
            il = .AddItem(ReadField(vRS.Fields("SupName")))
            .ItemImage(il) = 1
            .CellText(il, 1) = ReadField(vRS.Fields("SupID"))
            .CellText(il, 2) = ReadField(vRS.Fields("CPName")) & " - " & ReadField(vRS.Fields("CPPosition"))
            .CellText(il, 3) = ReadField(vRS.Fields("Address"))
...
Public Function Form_Edit()
    ...
    lSupID = GetTxtVal(listEntries.CellText(listEntries.Row, 1))
...
Public Function Form_Delete()
    ...
    If MsgBox("Are you sure you want to delete this Supplier entry named   '" & listEntries.CellText(listEntries.Row, 0) & "' ?", vbQuestion + vbYesNo + vbDefaultButton2) <> vbYes Then
        Exit Function
    End If
    ...
    If DeleteSup(lSupID) = True Then
        Form_Refresh
    Else
        WriteErrorLog Me.Name, "Form_Delete", "Failed on: 'DeleteSup(lSupID) = True'"
    End If
