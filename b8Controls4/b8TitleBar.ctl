...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
    ...
    lblCaption.Caption = PropBag.ReadProperty("Caption", "b8 Title Bar")
    ...
    lblShadow.Caption = PropBag.ReadProperty("Caption", "b8 Title Bar")
...
Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
    ...
    Call PropBag.WriteProperty("Caption", lblCaption.Caption, "b8 Title Bar")
